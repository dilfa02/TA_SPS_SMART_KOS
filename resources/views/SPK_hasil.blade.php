...
<body>
    <nav class="navbar navbar-expand-lg mt-2">
        ...
        <span>
            <h2>Kamu Ingin Mencari Kos?</h2><p>Pilihlah maksimal 3 kriteria pada "Filter SPK" sesuai keinginan anda:</p>
        </span>
    ...
    <div class="col-auto ms-5 mt-5">
      <nav class="h-100 flex-column align-items-stretch pe-4 border-end border-3">
        ...
        @csrf
            ...
            <div class="row">
                <div class="col">
                    <span class="btn btn-dark btn-sm" onclick="clearRadio()">Batal</span>
                </div>
    ...
    <div class="col mt-4">
        <div class="px-5">
            <div style="justify-content: right" class="d-flex mb-3 py-2">
                <div class="row w-100 align-items-center">
                    <div class="col text-left">
                        <b>Alternatif / <span class="text-muted">Hasil rekomendasi</span></b>
                    </div>
            ...
            <div class="mb-5">
                ...
                @elseif ($pilih == false)
                    <h4 class="text-center py-5">Tidak ada alternatif yang dipilih</h4>
                @else
