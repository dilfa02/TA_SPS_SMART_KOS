        ...
        <form action="{{ route('hasil') }}" method="POST">
            ...
            <div>
                ...
                <select class="form-select mb-3" id="inputGroupSelect01" name="C7"
                    ...
                    <option value="7">Sunyi, Dekat Pertokoan, Dekat SPBU, Dekat Supermarket, Dekat Warung Makan
                    </option>
                    <option value="8">Ramai, Dekat Pertokoan, Dekat SPBU, Dekat Supermarket, Dekat Warung Makan
                    </option>
                </select>
                ...
                <select class="form-select mb-3" id="inputGroupSelect01" name="C8"
                    ...
                    <option value="5">Dapur, Peralatan Dapur, Listrik, Air, Jemuran, WC Umum, Wifi, Ruang Tamu
                    </option>
                    <option value="6">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, WC Umum, Wifi
                    </option>
                    <option value="7">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, Wifi, Ruang Tamu
                    </option>
                    <option value="8">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, WC Umum, Wifi, Ruang
                        Tamu</option>
                </select>
