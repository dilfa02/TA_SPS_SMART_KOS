...
<body>
    ...
    <div class="container-fluid" id="main">
        <a href="{{ route('SPK') }}" class="text-decoration-none text-dark">
            <nav class="navbar navbar-expand-lg mt-2 border-bottom border-2">
                <img src="/image/logo.png" alt="" width="170px" height="80px" id="logo">
                <span>
                    <h2>Kamu Ingin Mencari Kos?</h2><p>Pilihlah maksimal 3 kriteria pada "Pilih kriteria" sesuai keinginan anda:</p>
                </span>
            </nav>
        </a>
        
        <div class="offcanvas offcanvas-start @if($pilih == true && $keterangan != "Semua") show @endif" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Filter SPK</h5>
                ...
                @csrf
                    <ul class="list-unstyled components" id="alternatif">
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('kk_alternatif', $filters)) show @endif" id="kk">
                                <li>
                                    <input type="radio" id="kk1" name="kk_alternatif" value="1" @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 1) checked @endif>
                                    <label for="kk1">Lembab, Ventilasi, Jendela, Paparan Sinar Matahari</label><br>
                                    <input type="radio" id="kk2" name="kk_alternatif" value="2"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 2) checked @endif>
                                    <label for="kk2">Lembab, Ventilasi, Jendela</label><br>
                                    <input type="radio" id="kk3" name="kk_alternatif" value="3"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 3) checked @endif>
                                    <label for="kk3">Kering, Jendela</label><br>
                                    <input type="radio" id="kk4" name="kk_alternatif" value="4"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 4) checked @endif>
                                    <label for="kk4">Kering, Jendela, Blower</label><br>
                                    <input type="radio" id="kk5" name="kk_alternatif" value="5"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 5) checked @endif>
                                    <label for="kk5">Kering, Ventilasi, Jendela</label><br>
                                    <input type="radio" id="kk6" name="kk_alternatif" value="6"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 6) checked @endif>
                                    <label for="kk6">Kering, Jendela, Paparan Sinar Matahari</label><br>
                                    <input type="radio" id="kk7" name="kk_alternatif" value="7"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 7) checked @endif>
                                    <label for="kk7">Kering, Ventilasi, Jendela, Paparan Sinar Matahari</label><br>
                                    <input type="radio" id="kk8" name="kk_alternatif" value="8"  @if(array_key_exists('kk_alternatif', $filters) && $filters['kk_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('harga_alternatif', $filters)) show @endif" id="harga">
                                <li>
                                    <input type="radio" id="harga1" name="harga_alternatif" value="1" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 1) checked @endif>
                                    <label for="harga1">> 1.800.000</label><br>
                                    <input type="radio" id="harga2" name="harga_alternatif" value="2" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 2) checked @endif>
                                    <label for="harga2">1.600.000 < H ≤ 1.800.000</label><br>
                                    <input type="radio" id="harga3" name="harga_alternatif" value="3" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 3) checked @endif>
                                    <label for="harga3">1.400.000 < H ≤ 1.600.000</label><br>
                                    <input type="radio" id="harga4" name="harga_alternatif" value="4" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 4) checked @endif>
                                    <label for="harga4">1.200.000 < H ≤ 1.400.000</label><br>
                                    <input type="radio" id="harga5" name="harga_alternatif" value="5" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 5) checked @endif>
                                    <label for="harga5">1.000.000 < H ≤ 1.200.000</label><br>
                                    <input type="radio" id="harga6" name="harga_alternatif" value="6" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 6) checked @endif>
                                    <label for="harga6">800.000 < H ≤ 1.000.000</label><br>
                                    <input type="radio" id="harga7" name="harga_alternatif" value="7" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 7) checked @endif>
                                    <label for="harga7">600.000 < H ≤ 800.000</label><br>
                                    <input type="radio" id="harga8" name="harga_alternatif" value="8" @if(array_key_exists('harga_alternatif', $filters) && $filters['harga_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('fk_alternatif', $filters)) show @endif" id="fk">
                                <li>
                                    <input type="radio" id="fk1" name="fk_alternatif" value="1" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 1) checked @endif>
                                    <label for="fk1">Kasur, Lemari, Meja</label><br>
                                    <input type="radio" id="fk2" name="fk_alternatif" value="2" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 2) checked @endif>
                                    <label for="fk2">WC, Kasur, Token Listrik</label><br>
                                    <input type="radio" id="fk3" name="fk_alternatif" value="3" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 3) checked @endif>
                                    <label for="fk3">WC, Kasur, Lemari, Meja</label><br>
                                    <input type="radio" id="fk4" name="fk_alternatif" value="4" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 4) checked @endif>
                                    <label for="fk4">Kasur, Lemari, Meja, Kipas Angin</label><br>
                                    <input type="radio" id="fk5" name="fk_alternatif" value="5" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 5) checked @endif>
                                    <label for="fk5">Kasur, Lemari, Meja, Kursi, Kipas Angin</label><br>
                                    <input type="radio" id="fk6" name="fk_alternatif" value="6" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 6) checked @endif>
                                    <label for="fk6">Kasur, Lemari, Meja, Kursi, AC</label><br>
                                    <input type="radio" id="fk7" name="fk_alternatif" value="7" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 7) checked @endif>
                                    <label for="fk7">WC, Kasur, Lemari, Meja, Kursi, Kipas Angin</label><br>
                                    <input type="radio" id="fk8" name="fk_alternatif" value="8" @if(array_key_exists('fk_alternatif', $filters) && $filters['fk_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('kkm_alternatif', $filters)) show @endif" id="kkm">
                                <li>
                                    <input type="radio" id="kkm1" name="kkm_alternatif" value="1" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 1) checked @endif>
                                    <label for="kkm1">Kloset Jongkok, Ventilasi, Lembab, Kotor</label><br>
                                    <input type="radio" id="kkm2" name="kkm_alternatif" value="2" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 2) checked @endif>
                                    <label for="kkm2">Kloset Jongkok, Ventilasi, Lembab, Bersih</label><br>
                                    <input type="radio" id="kkm3" name="kkm_alternatif" value="3" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 3) checked @endif>
                                    <label for="kkm3">Kloset Jongkok, Kering, Bersih</label><br>
                                    <input type="radio" id="kkm4" name="kkm_alternatif" value="4" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 4) checked @endif>
                                    <label for="kkm4">Kloset duduk, Kering, Bersih, Ventilasi</label><br>
                                    <input type="radio" id="kkm5" name="kkm_alternatif" value="5" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 5) checked @endif>
                                    <label for="kkm5">Kloset Jongkok, Kering, Bersih, Ventilasi</label><br>
                                    <input type="radio" id="kkm6" name="kkm_alternatif" value="6" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 6) checked @endif>
                                    <label for="kkm6">Kloset Duduk, Kering, Bersih, Blower</label><br>
                                    <input type="radio" id="kkm7" name="kkm_alternatif" value="7" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 7) checked @endif>
                                    <label for="kkm7">Kloset Jongkok, Kering, Bersih, Blower</label><br>
                                    <input type="radio" id="kkm8" name="kkm_alternatif" value="8" @if(array_key_exists('kkm_alternatif', $filters) && $filters['kkm_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('keamanan_alternatif', $filters)) show @endif" id="keamanan">
                                <li>
                                    <input type="radio" id="keamanan1" name="keamanan_alternatif" value="1" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 1) checked @endif>
                                    <label for="keamanan1">Tanpa Keamanan</label><br>
                                    <input type="radio" id="keamanan2" name="keamanan_alternatif" value="2" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 2) checked @endif>
                                    <label for="keamanan2">Penjaga Kos</label><br>
                                    <input type="radio" id="keamanan3" name="keamanan_alternatif" value="3" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 3) checked @endif>
                                    <label for="keamanan3">Pagar</label><br>
                                    <input type="radio" id="keamanan4" name="keamanan_alternatif" value="4" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 4) checked @endif>
                                    <label for="keamanan4">Pagar, Penjaga Kos</label><br>
                                    <input type="radio" id="keamanan5" name="keamanan_alternatif" value="5" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 5) checked @endif>
                                    <label for="keamanan5">Penjaga Kos, CCTV Parkiran/Luar</label><br>
                                    <input type="radio" id="keamanan6" name="keamanan_alternatif" value="6" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 6) checked @endif>
                                    <label for="keamanan6">PagPenjaga Kos, CCTV Parkiran/Luar, CCTV ruangan Umumar</label><br>
                                    <input type="radio" id="keamanan7" name="keamanan_alternatif" value="7" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 7) checked @endif>
                                    <label for="keamanan7">Pagar, Penjaga Kos, CCTV Parkiran/Luar</label><br>
                                    <input type="radio" id="keamanan8" name="keamanan_alternatif" value="8" @if(array_key_exists('keamanan_alternatif', $filters) && $filters['keamanan_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('jarak_alternatif', $filters)) show @endif" id="jarak">
                                <li>
                                    <input type="radio" id="jarak1" name="jarak_alternatif" value="1" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 1) checked @endif>
                                    <label for="jarak1">> 6 km</label><br>
                                    <input type="radio" id="jarak2" name="jarak_alternatif" value="2" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 2) checked @endif>
                                    <label for="jarak2">5 km < J ≤ 6 km</label><br>
                                    <input type="radio" id="jarak3" name="jarak_alternatif" value="3" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 3) checked @endif>
                                    <label for="jarak3">4 km < J ≤ 5 km</label><br>
                                    <input type="radio" id="jarak4" name="jarak_alternatif" value="4" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 4) checked @endif>
                                    <label for="jarak4">3 km < J ≤ 4 km</label><br>
                                    <input type="radio" id="jarak5" name="jarak_alternatif" value="5" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 5) checked @endif>
                                    <label for="jarak5">2 km < J ≤ 3 km</label><br>
                                    <input type="radio" id="jarak6" name="jarak_alternatif" value="6" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 6) checked @endif>
                                    <label for="jarak6">1 km < J ≤ 2 km</label><br>
                                    <input type="radio" id="jarak7" name="jarak_alternatif" value="7" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 7) checked @endif>
                                    <label for="jarak7">500 m < J ≤ 1 km</label><br>
                                    <input type="radio" id="jarak8" name="jarak_alternatif" value="8" @if(array_key_exists('jarak_alternatif', $filters) && $filters['jarak_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('lingkungan_alternatif', $filters)) show @endif" id="lingkungan">
                                <li>
                                    <input type="radio" id="lingkungan1" name="lingkungan_alternatif" value="1" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 1) checked @endif>
                                    <label for="lingkungan1">Sunyi</label><br>
                                    <input type="radio" id="lingkungan2" name="lingkungan_alternatif" value="2" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 2) checked @endif>
                                    <label for="lingkungan2">Ramai</label><br>
                                    <input type="radio" id="lingkungan3" name="lingkungan_alternatif" value="3" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 3) checked @endif>
                                    <label for="lingkungan3">Sunyi, Dekat Pertokoan</label><br>
                                    <input type="radio" id="lingkungan4" name="lingkungan_alternatif" value="4" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 4) checked @endif>
                                    <label for="lingkungan4">Ramai, Dekat Pertokoan</label><br>
                                    <input type="radio" id="lingkungan5" name="lingkungan_alternatif" value="5" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 5) checked @endif>
                                    <label for="lingkungan5">Sunyi, Dekat Pertokoan, Dekat Warung Makan</label><br>
                                    <input type="radio" id="lingkungan6" name="lingkungan_alternatif" value="6" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 6) checked @endif>
                                    <label for="lingkungan6">Ramai, Dekat Pertokoan, Dekat Warung Makan</label><br>
                                    <input type="radio" id="lingkungan7" name="lingkungan_alternatif" value="7" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 7) checked @endif>
                                    <label for="lingkungan7">Sunyi, Dekat Pertokoan, Dekat SPBU, Dekat Supermarket, Dekat Warung Makan</label><br>
                                    <input type="radio" id="lingkungan8" name="lingkungan_alternatif" value="8" @if(array_key_exists('lingkungan_alternatif', $filters) && $filters['lingkungan_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('fu_alternatif', $filters)) show @endif" id="fu">
                                <li>
                                    <input type="radio" id="fu1" name="fu_alternatif" value="1" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 1) checked @endif>
                                    <label for="fu1">Listrik, Air, Jemuran, WC Umum, Wifi</label><br>
                                    <input type="radio" id="fu2" name="fu_alternatif" value="2" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 2) checked @endif>
                                    <label for="fu2">Dapur, Listrik, Air, Jemuran, Wifi</label><br>
                                    <input type="radio" id="fu3" name="fu_alternatif" value="3" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 3) checked @endif>
                                    <label for="fu3">Dapur, Listrik, Air, Kulkas, Jemuran, WC Umum, Wifi</label><br>
                                    <input type="radio" id="fu4" name="fu_alternatif" value="4" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 4) checked @endif>
                                    <label for="fu4">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, Wifi</label><br>
                                    <input type="radio" id="fu5" name="fu_alternatif" value="5" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 5) checked @endif>
                                    <label for="fu5">Dapur, Peralatan Dapur, Listrik, Air, Jemuran, WC Umum, Wifi, Ruang Tamu</label><br>
                                    <input type="radio" id="fu6" name="fu_alternatif" value="6" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 6) checked @endif>
                                    <label for="fu6">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, WC Umum, Wifi</label><br>
                                    <input type="radio" id="fu7" name="fu_alternatif" value="7" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 7) checked @endif>
                                    <label for="fu7">Dapur, Peralatan Dapur, Listrik, Air, Kulkas, Jemuran, Wifi, Ruang Tamu</label><br>
                                    <input type="radio" id="fu8" name="fu_alternatif" value="8" @if(array_key_exists('fu_alternatif', $filters) && $filters['fu_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('lk_alternatif', $filters)) show @endif" id="lk">
                                <li>
                                    <input type="radio" id="lk1" name="lk_alternatif" value="1" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 1) checked @endif>
                                    <label for="lk1">< 4 𝑚^2</label><br>
                                    <input type="radio" id="lk2" name="lk_alternatif" value="2" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 2) checked @endif>
                                    <label for="lk2">4 𝑚^2 < LK ≤ 6 𝑚^2</label><br>
                                    <input type="radio" id="lk3" name="lk_alternatif" value="3" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 3) checked @endif>
                                    <label for="lk3">6 𝑚^2 < LK ≤ 9 𝑚^2</label><br>
                                    <input type="radio" id="lk4" name="lk_alternatif" value="4" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 4) checked @endif>
                                    <label for="lk4">9 𝑚^2 < LK ≤ 12 𝑚^2</label><br>
                                    <input type="radio" id="lk5" name="lk_alternatif" value="5" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 5) checked @endif>
                                    <label for="lk5">12 𝑚^2 < LK ≤ 15 𝑚^2</label><br>
                                    <input type="radio" id="lk6" name="lk_alternatif" value="6" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 6) checked @endif>
                                    <label for="lk6">15 𝑚^2 < LK ≤ 16 𝑚^2</label><br>
                                    <input type="radio" id="lk7" name="lk_alternatif" value="7" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 7) checked @endif>
                                    <label for="lk7">16 𝑚^2 < LK ≤ 20 𝑚^2</label><br>
                                    <input type="radio" id="lk8" name="lk_alternatif" value="8" @if(array_key_exists('lk_alternatif', $filters) && $filters['lk_alternatif'] == 8) checked @endif>
                        ...
                        <li class="mt-2">
                            ...
                            <ul class="collapse list-unstyled ms-3 @if(array_key_exists('parkiran_alternatif', $filters)) show @endif" id="parkiran">
                                <li>
                                    <input type="radio" id="parkiran1" name="parkiran_alternatif" value="1" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 1) checked @endif>
                                    <label for="parkiran1">Tidak Ada</label><br>
                                    <input type="radio" id="parkiran2" name="parkiran_alternatif" value="2" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 2) checked @endif>
                                    <label for="parkiran2">1 - 2 Motor</label><br>
                                    <input type="radio" id="parkiran3" name="parkiran_alternatif" value="3" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 3) checked @endif>
                                    <label for="parkiran3">2 - 4 Motor</label><br>
                                    <input type="radio" id="parkiran4" name="parkiran_alternatif" value="4" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 4) checked @endif>
                                    <label for="parkiran4">4 - 7 Motor</label><br>
                                    <input type="radio" id="parkiran5" name="parkiran_alternatif" value="5" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 5) checked @endif>
                                    <label for="parkiran5">7 - 10 Motor</label><br>
                                    <input type="radio" id="parkiran6" name="parkiran_alternatif" value="6" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 6) checked @endif>
                                    <label for="parkiran6">> 10 Motor</label><br>
                                    <input type="radio" id="parkiran7" name="parkiran_alternatif" value="7" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 7) checked @endif>
                                    <label for="parkiran7">7 - 10 Motor & 1 - 2 Mobil</label><br>
                                    <input type="radio" id="parkiran8" name="parkiran_alternatif" value="8" @if(array_key_exists('parkiran_alternatif', $filters) && $filters['parkiran_alternatif'] == 8) checked @endif>
                    ...
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            <span href="" class="btn btn-dark btn-sm me-2" onclick="clearRadio()">Batal</span>
                ...
                <div class="px-5">
                    <div style="justify-content: right" class="d-flex mb-3 py-2">
                        <div class="row w-100 align-items-center">
                            ...
                            <div class="col-auto">
                                <button class="btn btn-block btn-sm btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">Pilih kriteria</button>
                            </div>
